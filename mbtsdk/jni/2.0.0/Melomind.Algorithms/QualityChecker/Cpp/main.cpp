...
int main()
{
    ...
    MBT_Matrix<float> trainingFeatures = MBT_readMatrix("C:/Users/Fanny/Documents/Melomind.Algorithms/QualityChecker/Files/trainingFeatures_Data570UnguidedtrainingQCNEW.txt");

    // Construction de trainingClasses (1x570)
    std::vector<std::complex<float> > tmp_trainingClasses = MBT_readVector("C:/Users/Fanny/Documents/Melomind.Algorithms/QualityChecker/Files/trainingClasses _Data570UnguidedtrainingQCNEW.txt");
    ...
    std::vector<std::complex<float> > tmp_w = MBT_readVector("C:/Users/Fanny/Documents/Melomind.Algorithms/QualityChecker/Files/trainingW_Data570UnguidedtrainingQCNEW.txt");
    std::vector<float> w;
    ...
    std::vector<std::complex<float> > tmp_mu = MBT_readVector("C:/Users/Fanny/Documents/Melomind.Algorithms/QualityChecker/Files/trainingMu_Data570UnguidedtrainingQCNEW.txt");
    std::vector<float> mu;
    ...
    std::vector<std::complex<float> > tmp_sigma = MBT_readVector("C:/Users/Fanny/Documents/Melomind.Algorithms/QualityChecker/Files/trainingSigma_Data570UnguidedtrainingQCNEW.txt");
