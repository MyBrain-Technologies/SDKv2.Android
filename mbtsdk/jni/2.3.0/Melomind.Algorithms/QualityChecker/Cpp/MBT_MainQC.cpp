...
void MBT_MainQC::MBT_featuresQualityChecker()
{
        ...
        //for (int ch=0;ch<1;ch++)
    {
        ...
        */
//            for(int i = 0; i < 88; i++){
//                __android_log_print(ANDROID_LOG_DEBUG, "m_testFeatures", "%.20f", m_testFeatures(5,i));
//            }
...
//                __android_log_print(ANDROID_LOG_DEBUG, "weight size ", "%d",  observedWeight.size());
//                __android_log_print(ANDROID_LOG_DEBUG, "0 ", "%f",  observedWeight[0]);
//                __android_log_print(ANDROID_LOG_DEBUG, "1 ", "%f",  observedWeight[1]);
//                __android_log_print(ANDROID_LOG_DEBUG, "2 ", "%f",  observedWeight[2]);
...
//
//
//__android_log_print(ANDROID_LOG_DEBUG, "m_sigma ", "%ld", m_sigma.size());
//__android_log_print(ANDROID_LOG_DEBUG, "m_sigma", "%f", m_sigma[0]);
//__android_log_print(ANDROID_LOG_DEBUG, "m_sigma", "%f", m_sigma[m_sigma.size()-1]);