...
public final class ConnectionException extends BaseException {
    ...
    public static final String ANOTHER_DEVICE_CONNECTED = "Another device is already connected, please call disconnect(), wait for the DISCONNECTED event in onStateChanged callback then try again";
