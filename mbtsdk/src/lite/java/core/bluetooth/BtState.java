...
public enum BtState {
     ...
     * The connection process that was running is automatically cancelled (stopped) if this state occurs and the SDK will returned to an IDLE state few minutes after it has returned the ANOTHER_DEVICE_CONNECTED state.
     */
