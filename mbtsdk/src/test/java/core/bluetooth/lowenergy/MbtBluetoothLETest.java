...
public class MbtBluetoothLETest {
    ...
    public void setUp() {
        ...
        bluetoothLE = new MbtBluetoothLE(bluetoothManager);
...
//    }
    ...
    public void notifyStreamStateChanged_Vpro() {
        ...
        MbtBluetoothSPP bluetoothSPP = new MbtBluetoothSPP(bluetoothManager);
    ...
    public void enableOrDisableNotificationsOnCharacteristic_ConnectedReadyEnable() {
        ...
        assertTrue(bluetoothLE.enableOrDisableNotificationsOnCharacteristic(true, bluetoothLE.getGatt().getService(SERVICE).getCharacteristic(CHARACTERISTIC_EEG)));
    ...
    public void enableOrDisableNotificationsOnCharacteristic_ConnectedReadyDisable() {
        ...
        assertTrue(bluetoothLE.enableOrDisableNotificationsOnCharacteristic(false, bluetoothLE.getGatt().getService(SERVICE).getCharacteristic(CHARACTERISTIC_EEG)));
    ...
    public void startLowEnergyScan_FailedNullNameFilterOn() {
        ...
        assertNotEquals(bluetoothLE.getCurrentState(), BluetoothState.SCAN_FAILURE);
    }
    ...
    public void stopLowEnergyScan_StateIsNotScanStarted() {
        ...
        assertNotEquals(bluetoothLE.getCurrentState(), BluetoothState.SCAN_STARTED);
    }
    ...
    public void stopLowEnergyScan_StateIsIdle() {
        bluetoothLE.stopScan();
        assertEquals(bluetoothLE.getCurrentState(), BluetoothState.IDLE);
    }
    ...
    public void connect_NonNullContext() {
        ...
        assertNull(bluetoothLE.getGatt());
    }
    ...
    public void connect_NullContext() {
        ...
        assertNotNull(bluetoothLE.getGatt());
    }
    ...
    public void startReadOperation_ConnectedNotReady() {
        ...
        assertEquals(bluetoothLE.getCurrentState(), BluetoothState.READING_FAILURE);
    }
...
//    }
    ...
    public void notifyConnectionStateChanged_notifyClientConnected() {
        ...
        assertEquals(bluetoothLE.getCurrentState(), BluetoothState.DATA_BT_CONNECTION_SUCCESS);
    }
    ...
    public void sendCommand_invalidConnectionState(){
        ...
        Mockito.verify(bluetoothManager).reader.notifyResponseReceived(null, command); //null response is supposed to be returned to notify the bluetooth manager that the command has failed to be sent
    }
    ...
    public void sendCommand_SuccessWithResponse() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        Mockito.verify(bluetoothManager).reader.notifyResponseReceived(mtu, command); //non null response is supposed to be returned to notify the bluetooth manager that the command has succeeded to be sent
    }
