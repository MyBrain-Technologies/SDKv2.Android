...
public class MobileDeviceError extends BaseError {
    ...
    public static MobileDeviceError ERROR_BLUETOOTH_DISABLED            = new MobileDeviceError( CODE_RANGE+2,  "This operation could not be started : Bluetooth is disabled or has failed to be enabled.");
