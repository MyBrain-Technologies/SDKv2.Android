...
public class HeadsetDeviceError extends BaseError {
    ...
    public static HeadsetDeviceError ERROR_DECODE_BATTERY                   = new HeadsetDeviceError( CODE_RANGE+6,  "Failed to decode battery level value.");
    public static HeadsetDeviceError ERROR_TIMEOUT_SATURATION               = new HeadsetDeviceError( CODE_RANGE+7,  "No received Saturation value within the permitted time.");
    public static HeadsetDeviceError ERROR_TIMEOUT_OFFSET                   = new HeadsetDeviceError( CODE_RANGE+8,  "No received DC Offset value within the permitted time.");
    public static HeadsetDeviceError ERROR_PREFIX_NAME                      = new HeadsetDeviceError( CODE_RANGE+9,  "Invalid headset name : it must start with melo_ prefix.");
    public static HeadsetDeviceError ERROR_MELOMIND_INCOMPATIBLE            = new HeadsetDeviceError( CODE_RANGE+10,  "Feature not available for Melomind headset.");
    public static HeadsetDeviceError ERROR_VPRO_INCOMPATIBLE                = new HeadsetDeviceError( CODE_RANGE+11,  "Feature not available for VPro headset.");
    public static HeadsetDeviceError ERROR_SENSORS                          = new HeadsetDeviceError( CODE_RANGE+12,  "This operation encountered a problem : check that the electrodes are plugged.");
