...
public final class EncryptionUtils {
     ...
     */
    public static final String keyString(final SecretKeys keys) {
     ...
     */
    public static final SecretKeys keys(final String keysStr) throws InvalidKeyException {
     ...
     */
    public static final SecretKeys generateKey() throws GeneralSecurityException {
        fixPrng();
     ...
     *                                  or a suitable RNG is not available
     */
    public static final SecretKeys generateKeyFromPassword(final String password, final byte[] salt) throws GeneralSecurityException {
        fixPrng();
        ...
        final byte[] confidentialityKeyBytes = copyOfRange(keyBytes, 0, AES_KEY_LENGTH_BITS /8);
        final byte[] integrityKeyBytes = copyOfRange(keyBytes, AES_KEY_LENGTH_BITS /8, AES_KEY_LENGTH_BITS /8 + HMAC_KEY_LENGTH_BITS /8);
     ...
     */
    public static final String saltString(final byte[] salt) {
    ...
    public static CipherTextIvMac encrypt(final byte[] plaintext, final SecretKeys secretKeys)
        ...
        final byte[] byteCipherText = aesCipherForEncryption.doFinal(plaintext);
        final byte[] ivCipherConcat = CipherTextIvMac.ivCipherConcat(iv, byteCipherText);

        final byte[] integrityMac = generateMac(ivCipherConcat, secretKeys.getIntegrityKey());
    ...
    public final static class SecretKeys {
         ...
         */
        public SecretKeys(final SecretKey confidentialityKeyIn, final SecretKey integrityKeyIn) {
            this.confidentialityKey = confidentialityKeyIn;
            this.integrityKey = integrityKeyIn;
        }
        ...
        public final void setConfidentialityKey(SecretKey confidentialityKey) {
        ...
        public final void setIntegrityKey(SecretKey integrityKey) {
    ...
    public static final class CipherTextIvMac {
        ...
        public CipherTextIvMac(final String base64IvAndCiphertext) {
            ...
            if (civArray.length != 3) {
                ...
                this.iv = Base64.decode(civArray[0], BASE64_FLAGS);
                this.mac = Base64.decode(civArray[1], BASE64_FLAGS);
                this.cipherText = Base64.decode(civArray[2], BASE64_FLAGS);
            }
        }
        ...
        @Override
        public final String toString() {
            final String ivString = Base64.encodeToString(iv, BASE64_FLAGS);
            final String cipherTextString = Base64.encodeToString(cipherText, BASE64_FLAGS);
            final String macString = Base64.encodeToString(mac, BASE64_FLAGS);
    ...
    public static final class PrngFixes {
        ...
        private static void applyOpenSSLFix() throws SecurityException {
            ...
            try {
                ...
                final int bytesRead = (Integer) Class
