...
set_target_properties(SignalProcessing::DataManipulation PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libDataManipulation.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::DataManipulation )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::DataManipulation "${_IMPORT_PREFIX}/lib/x86/libDataManipulation.a" )
...
set_target_properties(SignalProcessing::Transformations PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libTransformations.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::Transformations )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::Transformations "${_IMPORT_PREFIX}/lib/x86/libTransformations.a" )
...
set_target_properties(SignalProcessing::Algebra PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libAlgebra.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::Algebra )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::Algebra "${_IMPORT_PREFIX}/lib/x86/libAlgebra.a" )
...
set_target_properties(SignalProcessing::PreProcessing PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libPreProcessing.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::PreProcessing )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::PreProcessing "${_IMPORT_PREFIX}/lib/x86/libPreProcessing.a" )
