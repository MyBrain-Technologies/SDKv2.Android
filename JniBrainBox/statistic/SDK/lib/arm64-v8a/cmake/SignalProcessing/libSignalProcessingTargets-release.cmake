...
set_target_properties(SignalProcessing::DataManipulation PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/arm64-v8a/libDataManipulation.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::DataManipulation )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::DataManipulation "${_IMPORT_PREFIX}/lib/arm64-v8a/libDataManipulation.a" )
...
set_target_properties(SignalProcessing::Transformations PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/arm64-v8a/libTransformations.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::Transformations )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::Transformations "${_IMPORT_PREFIX}/lib/arm64-v8a/libTransformations.a" )
...
set_target_properties(SignalProcessing::Algebra PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/arm64-v8a/libAlgebra.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::Algebra )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::Algebra "${_IMPORT_PREFIX}/lib/arm64-v8a/libAlgebra.a" )
...
set_target_properties(SignalProcessing::PreProcessing PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/arm64-v8a/libPreProcessing.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SignalProcessing::PreProcessing )
list(APPEND _IMPORT_CHECK_FILES_FOR_SignalProcessing::PreProcessing "${_IMPORT_PREFIX}/lib/arm64-v8a/libPreProcessing.a" )
